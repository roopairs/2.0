...
export default class ConnectAccountCard extends React.Component<ConnectAccountProps> {
    
    connectAccount = () => {
        //TODO: Call asyncronous fetch (From fetch or axios) to connect Roopairs account
        alert('I need to connect')
        this.props.connectAccountCallBack('TODO: Insert Parameters for call back (might be a json)!')
    }
        ...
        return(
           <View style={styles.accountContainer}>
               <View style={styles.textContainer}>
                <Text style={styles.cardTitle}>Connect Roopairs Account</Text>
                <Text style ={styles.cardDescription}>
                    Connect your roopairs account for on-demand service 
                     </Text>
                </View>
