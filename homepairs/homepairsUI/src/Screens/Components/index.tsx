...
import { SceneInjectedProps as SIP} from './SceneHeader/WithSceneHeader';
import { AuthPageInjectedProps as APIP, AuthPassProps as APP} from './AuthPage/WithAuthPage'
import { DarkModeInjectedProps as DMIP} from './WithDarkMode/WithDarkMode';
...
export {default as withScene} from './SceneHeader/WithSceneHeader';
export {default as AddNewPropertyModal} from './Modals/AddNewPropertyModal/AddNewPropertyModal';
export {default as PresentNewRequestModal} from './Modals/ServiceRequestModal/PresentNewRequestModal';
export {default as withAuthPage} from './AuthPage/WithAuthPage';
export {default as withDarkMode} from './WithDarkMode/WithDarkMode';
