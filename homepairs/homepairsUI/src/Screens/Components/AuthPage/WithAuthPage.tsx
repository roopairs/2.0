...
import { ModalInjectedProps } from "homepair-components";
              ...
              <View style={styles.container}>
                ...
                <View style={styles.signUpSection}>
                  <Text style={styles.standardText}>
                    ...
                    <Text
                      style={{ color: colors.LightModeColors.title }}
...
function setStyles(buttonColor: string, colorTheme?: BaseStyles.ColorTheme) {
  ...
  return StyleSheet.create({
    ...
    subTitleText: {
      ...
      fontSize:
        Dimensions.get("window").width > HomePairsDimensions.DROP_MENU_WIDTH
