...
import  AddNewPropertyModalBase, { AddNewPropertyDispatchProps, NewPropertyState} from './AddNewPropertyModalBase';

const mapDispatchToProps : (dispatch: any) => AddNewPropertyDispatchProps = (dispatch: any) => ({
    onCreateProperty: (newProperty: Property, info: NewPropertyState, setInitialState: () => void, onChangeModalVisiblity: (check: boolean) => void) => {
