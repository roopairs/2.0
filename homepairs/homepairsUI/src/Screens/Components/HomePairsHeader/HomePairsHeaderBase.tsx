...
} from "./HomePairsHeaderTitle/HomePairsHeaderTitle";
import HomePairsMenu, {
  HomePairsMenuProps
} from "./HomePairsHeaderMenu/HomePairsHeaderMenu";
  ...
  render() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={{ flexDirection: "row", backgroundColor: this.colorScheme.secondary}}>
            {this.showBackButton()}
            <View
              style={
                this.showBackButton
