import { Text, View, ScrollView, Modal, ActivityIndicator, StatusBar, Alert, StyleSheet } from 'react-native';
...
export default class LoginScreenBase extends LoginView {
    presentLoading = () => {
        return(
            <Modal
                animationType='fade'
                ...
                onRequestClose={() => {}}>
                    ...
                    <View 
                    style={styles.loadingCardContents}>
                    <ActivityIndicator />
