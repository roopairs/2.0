...
function parseTypeScriptSourceFile(fileContent, filePath, tsConfigs) {
    try {
        ...
        const result = tsParser.parseForESLint(fileContent, Object.assign({}, exports.PARSER_CONFIG_MODULE, { filePath: filePath, project: tsConfigs, loggerFn: console.log }));
        return new eslint_1.SourceCode(Object.assign({}, result, { parserServices: result.services, text: fileContent }));
    }
    catch (exception) {
        return {
