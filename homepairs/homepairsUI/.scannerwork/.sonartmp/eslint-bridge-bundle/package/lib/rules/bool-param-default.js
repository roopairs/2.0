...
exports.rule = {
    create(context) {
        return {
            "FunctionDeclaration, FunctionExpression, ArrowFunctionExpression, TSEmptyBodyFunctionExpression, TSMethodSignature, TSFunctionType, TSConstructSignatureDeclaration": (node) => {
